            ...
            items: [
                {
                    ...
                    to: '/apps/medical/pacientes'
                },
                {
                    label: 'Médicos',
                    icon: 'pi pi-fw pi-user',
                    to: '/apps/medical/medicos'
                },
                {
                    label: 'Consultorios',
                    icon: 'pi pi-fw pi-home', // Puedes cambiar el icono si prefieres
                    to: '/apps/medical/consultorio'
                },
                {
                    label: 'Citas',
                    icon: 'pi pi-fw pi-calendar',
                    to: '/apps/medical/citas'
                }
            ]
        },
